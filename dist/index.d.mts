...
declare class TexasHoldem {
    private numSimulations;
    private numOpponents;
    private opponents;
    private player;
    private table;
    private deadCards;
    ...
    private removeCard;
    setPlayer(cards: string[], name?: string): void;
    addOpponent(cards: string[], options?: {
        name?: string;
        folded?: boolean;
    }): void;
    setTable(cards: string[]): void;
    calculate(): SimulationResults;
    private runSimulation;
    solveHand(cards: string[]): Hand;
}

export { type SimulationResults, TexasHoldem };
